            ...
            <div class="col-md-8">
                ...
                <?php 
                    ...
                    if(isset($_POST['searchdata'])){
                        ...
                        $query = "SELECT * FROM post WHERE status='Public' AND title LIKE '%$search%' || author LIKE '%$search%' || category LIKE '%$search%'";
                ...
                <p>
                    <span class="glyphicon glyphicon-time"></span> Posted on <?php echo $value['date'] ?>
                </p>
                <hr>
